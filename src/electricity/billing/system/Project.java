...
public class Project extends JFrame implements ActionListener{
    ...
    Project(String atype, String meter) {
        ...
        ImageIcon icon111 = new ImageIcon(ClassLoader.getSystemResource("icon/icon1.png"));
        Image image111 = icon111.getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT);
        deletecustomer.setIcon(new ImageIcon(image111));
        deletecustomer.setMnemonic('C');
        deletecustomer.addActionListener(this);
        deletecustomer.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, ActionEvent.CTRL_MASK));
